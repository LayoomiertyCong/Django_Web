...
urlpatterns = [
    ...
    url(r'^customer_query_supplier/(.+)/$',app.customer.customer_query_supplier,name='customer_query_supplier'),
    ...
    url(r'^sup_query_customer_information/(.+)/$',app.supplier.sup_query_customer_information,name='sup_query_customer_information'),
    url(r'^sup_query_order_information/(.+)/$',app.supplier.sup_query_order_information,name='sup_query_order_information'),
    url(r'^sup_query_waybill_information/(.+)/$',app.supplier.sup_query_waybill_information,name='sup_query_waybill_information'),
    url(r'^sup_query_recent_order_by_time/(.+)/$',app.supplier.sup_query_recent_order_by_time,name='sup_query_recent_order_by_time'),
    url(r'^sup_query_recent_waybill_by_time/(.+)/$',app.supplier.sup_query_recent_waybill_by_time,name='sup_query_recent_waybill_by_time'),
    ...
    url(r'^dep_query_route_information/(.+)/$',app.depository.dep_query_route_information,name='dep_query_route_information'),
    ...
    url(r'^lc_delete_user/(.+)/$',app.logisticcenter.lc_delete_user,name='lc_delete_user'),
